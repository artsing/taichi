...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 63 07 00 00       	call   79d <unlink>
...
hexdump (void *data, size_t size) {
 ...
 439:	0f 85 f1 fe ff ff    	jne    330 <hexdump+0x50>
  ...
  printf(1, "+------+-------------------------------------------------+------------------+\n");
 43f:	c7 45 0c 88 0c 00 00 	movl   $0xc88,0xc(%ebp)
...
hton16 (uint16_t h)
{
 ...
 504:	55                   	push   %ebp
    if (!endian)
 505:	a1 c4 10 00 00       	mov    0x10c4,%eax
{
 ...
 511:	75 1d                	jne    530 <hton16+0x30>
        endian = byteorder();
 513:	c7 05 c4 10 00 00 d2 	movl   $0x4d2,0x10c4
 51a:	04 00 00 
...
hton32(uint32_t h)
{
 ...
 554:	55                   	push   %ebp
    if (!endian)
 555:	8b 15 c4 10 00 00    	mov    0x10c4,%edx
{
 ...
 562:	75 14                	jne    578 <hton32+0x28>
        endian = byteorder();
 564:	c7 05 c4 10 00 00 d2 	movl   $0x4d2,0x10c4
 56b:	04 00 00 
    return (v & 0x000000ff) << 24 | (v & 0x0000ff00) << 8 | (v & 0x00ff0000) >> 8 | (v & 0xff000000) >> 24;
 56e:	0f c8                	bswap  %eax
 ...
 84c:	89 d1                	mov    %edx,%ecx
{
 ...
 879:	0f b6 92 f8 0c 00 00 	movzbl 0xcf8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 a74:	eb 1a                	jmp    a90 <printf+0x1a0>
          s = "(null)";
 a76:	bb f0 0c 00 00       	mov    $0xcf0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 ac5:	a1 c8 10 00 00       	mov    0x10c8,%eax
{
 ...
 ae6:	73 10                	jae    af8 <free+0x38>
{
 ...
 b11:	5b                   	pop    %ebx
  freep = p;
 b12:	a3 c8 10 00 00       	mov    %eax,0x10c8
}
 b17:	5e                   	pop    %esi
 b18:	5f                   	pop    %edi
 b19:	5d                   	pop    %ebp
 ...
 b37:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 b3a:	a3 c8 10 00 00       	mov    %eax,0x10c8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 b5d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 b60:	8b 3d c8 10 00 00    	mov    0x10c8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 ba9:	8b 3d c8 10 00 00    	mov    0x10c8,%edi
 ...
 bd2:	e8 e9 fe ff ff       	call   ac0 <free>
  return freep;
 bd7:	a1 c8 10 00 00       	mov    0x10c8,%eax
 ...
 c04:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 c07:	a3 c8 10 00 00       	mov    %eax,0x10c8
}
 ...
 c1e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 c20:	c7 05 c8 10 00 00 cc 	movl   $0x10cc,0x10c8
 c27:	10 00 00 
    base.s.size = 0;
 c2a:	bf cc 10 00 00       	mov    $0x10cc,%edi
    base.s.ptr = freep = prevp = &base;
 c2f:	c7 05 cc 10 00 00 cc 	movl   $0x10cc,0x10cc
 c36:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 c39:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 c3b:	c7 05 d0 10 00 00 00 	movl   $0x0,0x10d0
 c42:	00 00 00 
    if(p->s.size >= nunits){
