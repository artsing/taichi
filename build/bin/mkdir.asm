...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 db 07 00 00       	call   815 <mkdir>
...
hexdump (void *data, size_t size) {
 ...
 499:	0f 85 f1 fe ff ff    	jne    390 <hexdump+0x50>
  ...
  printf(1, "+------+-------------------------------------------------+------------------+\n");
 49f:	c7 45 0c ec 0c 00 00 	movl   $0xcec,0xc(%ebp)
...
hton16 (uint16_t h)
{
 ...
 564:	55                   	push   %ebp
    if (!endian)
 565:	a1 58 11 00 00       	mov    0x1158,%eax
{
 ...
 571:	75 1d                	jne    590 <hton16+0x30>
        endian = byteorder();
 573:	c7 05 58 11 00 00 d2 	movl   $0x4d2,0x1158
 57a:	04 00 00 
...
hton32(uint32_t h)
{
 ...
 5b4:	55                   	push   %ebp
    if (!endian)
 5b5:	8b 15 58 11 00 00    	mov    0x1158,%edx
{
 ...
 5c2:	75 14                	jne    5d8 <hton32+0x28>
        endian = byteorder();
 5c4:	c7 05 58 11 00 00 d2 	movl   $0x4d2,0x1158
 5cb:	04 00 00 
    return (v & 0x000000ff) << 24 | (v & 0x0000ff00) << 8 | (v & 0x00ff0000) >> 8 | (v & 0xff000000) >> 24;
 5ce:	0f c8                	bswap  %eax
 ...
 8ac:	89 d1                	mov    %edx,%ecx
{
 ...
 8d9:	0f b6 92 5c 0d 00 00 	movzbl 0xd5c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 ad4:	eb 1a                	jmp    af0 <printf+0x1a0>
          s = "(null)";
 ad6:	bb 54 0d 00 00       	mov    $0xd54,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 b25:	a1 5c 11 00 00       	mov    0x115c,%eax
{
 ...
 b46:	73 10                	jae    b58 <free+0x38>
{
 ...
 b71:	5b                   	pop    %ebx
  freep = p;
 b72:	a3 5c 11 00 00       	mov    %eax,0x115c
}
 b77:	5e                   	pop    %esi
 b78:	5f                   	pop    %edi
 b79:	5d                   	pop    %ebp
 ...
 b97:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 b9a:	a3 5c 11 00 00       	mov    %eax,0x115c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 bbd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 bc0:	8b 3d 5c 11 00 00    	mov    0x115c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 c09:	8b 3d 5c 11 00 00    	mov    0x115c,%edi
 ...
 c32:	e8 e9 fe ff ff       	call   b20 <free>
  return freep;
 c37:	a1 5c 11 00 00       	mov    0x115c,%eax
 ...
 c64:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 c67:	a3 5c 11 00 00       	mov    %eax,0x115c
}
 ...
 c7e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 c80:	c7 05 5c 11 00 00 60 	movl   $0x1160,0x115c
 c87:	11 00 00 
    base.s.size = 0;
 c8a:	bf 60 11 00 00       	mov    $0x1160,%edi
    base.s.ptr = freep = prevp = &base;
 c8f:	c7 05 60 11 00 00 60 	movl   $0x1160,0x1160
 c96:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 c99:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 c9b:	c7 05 64 11 00 00 00 	movl   $0x0,0x1164
 ca2:	00 00 00 
    if(p->s.size >= nunits){
