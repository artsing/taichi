...
main(int argc, char *argv[])
{
  ...
  38:	68 bd 0c 00 00       	push   $0xcbd
  3d:	83 c3 04             	add    $0x4,%ebx
  40:	50                   	push   %eax
  41:	68 58 0c 00 00       	push   $0xc58
  46:	6a 01                	push   $0x1
  48:	e8 a3 08 00 00       	call   8f0 <printf>
  for(i = 1; i < argc; i++)
  ...
  exit();
  6c:	e8 dc 06 00 00       	call   74d <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
...
hexdump (void *data, size_t size) {
 ...
 439:	0f 85 f1 fe ff ff    	jne    330 <hexdump+0x50>
  ...
  printf(1, "+------+-------------------------------------------------+------------------+\n");
 43f:	c7 45 0c 60 0c 00 00 	movl   $0xc60,0xc(%ebp)
...
hton16 (uint16_t h)
{
 ...
 504:	55                   	push   %ebp
    if (!endian)
 505:	a1 94 10 00 00       	mov    0x1094,%eax
{
 ...
 511:	75 1d                	jne    530 <hton16+0x30>
        endian = byteorder();
 513:	c7 05 94 10 00 00 d2 	movl   $0x4d2,0x1094
 51a:	04 00 00 
...
hton32(uint32_t h)
{
 ...
 554:	55                   	push   %ebp
    if (!endian)
 555:	8b 15 94 10 00 00    	mov    0x1094,%edx
{
 ...
 562:	75 14                	jne    578 <hton32+0x28>
        endian = byteorder();
 564:	c7 05 94 10 00 00 d2 	movl   $0x4d2,0x1094
 56b:	04 00 00 
    return (v & 0x000000ff) << 24 | (v & 0x0000ff00) << 8 | (v & 0x00ff0000) >> 8 | (v & 0xff000000) >> 24;
 56e:	0f c8                	bswap  %eax
 ...
 84c:	89 d1                	mov    %edx,%ecx
{
 ...
 879:	0f b6 92 d0 0c 00 00 	movzbl 0xcd0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 a74:	eb 1a                	jmp    a90 <printf+0x1a0>
          s = "(null)";
 a76:	bb c8 0c 00 00       	mov    $0xcc8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 ac5:	a1 98 10 00 00       	mov    0x1098,%eax
{
 ...
 ae6:	73 10                	jae    af8 <free+0x38>
{
 ...
 b11:	5b                   	pop    %ebx
  freep = p;
 b12:	a3 98 10 00 00       	mov    %eax,0x1098
}
 b17:	5e                   	pop    %esi
 b18:	5f                   	pop    %edi
 b19:	5d                   	pop    %ebp
 ...
 b37:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 b3a:	a3 98 10 00 00       	mov    %eax,0x1098
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 b5d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 b60:	8b 3d 98 10 00 00    	mov    0x1098,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 ba9:	8b 3d 98 10 00 00    	mov    0x1098,%edi
 ...
 bd2:	e8 e9 fe ff ff       	call   ac0 <free>
  return freep;
 bd7:	a1 98 10 00 00       	mov    0x1098,%eax
 ...
 c04:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 c07:	a3 98 10 00 00       	mov    %eax,0x1098
}
 ...
 c1e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 c20:	c7 05 98 10 00 00 9c 	movl   $0x109c,0x1098
 c27:	10 00 00 
    base.s.size = 0;
 c2a:	bf 9c 10 00 00       	mov    $0x109c,%edi
    base.s.ptr = freep = prevp = &base;
 c2f:	c7 05 9c 10 00 00 9c 	movl   $0x109c,0x109c
 c36:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 c39:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 c3b:	c7 05 a0 10 00 00 00 	movl   $0x0,0x10a0
 c42:	00 00 00 
    if(p->s.size >= nunits){
