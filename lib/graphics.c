...
static void _box_blur_horizontal(gfx_context_t * _src, int radius) {
	...
	uint32_t * out_color = malloc(sizeof(uint32_t) *w);//calloc(sizeof(uint32_t), w);
...
static void _box_blur_vertical(gfx_context_t * _src, int radius) {
	...
	uint32_t * out_color = malloc(sizeof(uint32_t)* h);//calloc(sizeof(uint32_t), h);
