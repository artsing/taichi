...
main(int argc, char *argv[])
{
  ...
  55:	e8 db 09 00 00       	call   a35 <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	pushl  (%ebx)
  69:	e8 df 09 00 00       	call   a4d <open>
  ...
  77:	50                   	push   %eax
  78:	ff 33                	pushl  (%ebx)
  7a:	68 38 0f 00 00       	push   $0xf38
  7f:	6a 01                	push   $0x1
  81:	e8 2a 0b 00 00       	call   bb0 <printf>
      exit();
  86:	e8 82 09 00 00       	call   a0d <exit>
  }
  exit();
  8b:	e8 7d 09 00 00       	call   a0d <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  92:	68 18 0f 00 00       	push   $0xf18
  97:	6a 02                	push   $0x2
  99:	e8 12 0b 00 00       	call   bb0 <printf>
    exit();
  9e:	e8 6a 09 00 00       	call   a0d <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 83 01 00 00       	call   230 <grep>
    exit();
  ad:	e8 5b 09 00 00       	call   a0d <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
 ...
 23d:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
{
 ...
 25d:	50                   	push   %eax
 25e:	8d 81 a0 14 00 00    	lea    0x14a0(%ecx),%eax
 264:	50                   	push   %eax
 265:	ff 75 0c             	pushl  0xc(%ebp)
 268:	e8 b8 07 00 00       	call   a25 <read>
 ...
 27b:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
    p = buf;
 27e:	bb a0 14 00 00       	mov    $0x14a0,%ebx
    buf[m] = '\0';
 283:	c6 81 a0 14 00 00 00 	movb   $0x0,0x14a0(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2ce:	53                   	push   %ebx
 2cf:	6a 01                	push   $0x1
 2d1:	e8 57 07 00 00       	call   a2d <write>
 ...
 2de:	eb b0                	jmp    290 <grep+0x60>
    if(p == buf)
 2e0:	81 fb a0 14 00 00    	cmp    $0x14a0,%ebx
 ...
 2f5:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f8:	2d a0 14 00 00       	sub    $0x14a0,%eax
 2fd:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
 2ff:	51                   	push   %ecx
 300:	53                   	push   %ebx
 301:	68 a0 14 00 00       	push   $0x14a0
      m -= p - buf;
...
hexdump (void *data, size_t size) {
 ...
 6f9:	0f 85 f1 fe ff ff    	jne    5f0 <hexdump+0x50>
  ...
  printf(1, "+------+-------------------------------------------------+------------------+\n");
 6ff:	c7 45 0c 50 0f 00 00 	movl   $0xf50,0xc(%ebp)
...
hton16 (uint16_t h)
{
 ...
 7c4:	55                   	push   %ebp
    if (!endian)
 7c5:	a1 80 14 00 00       	mov    0x1480,%eax
{
 ...
 7d1:	75 1d                	jne    7f0 <hton16+0x30>
        endian = byteorder();
 7d3:	c7 05 80 14 00 00 d2 	movl   $0x4d2,0x1480
 7da:	04 00 00 
...
hton32(uint32_t h)
{
 ...
 814:	55                   	push   %ebp
    if (!endian)
 815:	8b 15 80 14 00 00    	mov    0x1480,%edx
{
 ...
 822:	75 14                	jne    838 <hton32+0x28>
        endian = byteorder();
 824:	c7 05 80 14 00 00 d2 	movl   $0x4d2,0x1480
 82b:	04 00 00 
    return (v & 0x000000ff) << 24 | (v & 0x0000ff00) << 8 | (v & 0x00ff0000) >> 8 | (v & 0xff000000) >> 24;
 82e:	0f c8                	bswap  %eax
 ...
 b0c:	89 d1                	mov    %edx,%ecx
{
 ...
 b39:	0f b6 92 c0 0f 00 00 	movzbl 0xfc0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 d34:	eb 1a                	jmp    d50 <printf+0x1a0>
          s = "(null)";
 d36:	bb b8 0f 00 00       	mov    $0xfb8,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 d85:	a1 84 14 00 00       	mov    0x1484,%eax
{
 ...
 da6:	73 10                	jae    db8 <free+0x38>
{
 ...
 df7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 dfa:	a3 84 14 00 00       	mov    %eax,0x1484
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 e1d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 e20:	8b 3d 84 14 00 00    	mov    0x1484,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 e69:	8b 3d 84 14 00 00    	mov    0x1484,%edi
 ...
 e92:	e8 e9 fe ff ff       	call   d80 <free>
  return freep;
 e97:	a1 84 14 00 00       	mov    0x1484,%eax
 ...
 ec4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 ec7:	a3 84 14 00 00       	mov    %eax,0x1484
}
 ...
 ede:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 ee0:	c7 05 84 14 00 00 88 	movl   $0x1488,0x1484
 ee7:	14 00 00 
    base.s.size = 0;
 eea:	bf 88 14 00 00       	mov    $0x1488,%edi
    base.s.ptr = freep = prevp = &base;
 eef:	c7 05 88 14 00 00 88 	movl   $0x1488,0x1488
 ef6:	14 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ef9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 efb:	c7 05 8c 14 00 00 00 	movl   $0x0,0x148c
 f02:	00 00 00 
    if(p->s.size >= nunits){
