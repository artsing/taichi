...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2c:	6a 02                	push   $0x2
      2e:	68 a9 17 00 00       	push   $0x17a9
      33:	e8 05 12 00 00       	call   123d <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      48:	80 3d 62 1f 00 00 20 	cmpb   $0x20,0x1f62
...
fork1(void)
{
  ...
  pid = fork();
      58:	e8 98 11 00 00       	call   11f5 <fork>
  if(pid == -1)
    ...
    wait();
      6e:	e8 92 11 00 00       	call   1205 <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
      73:	83 ec 08             	sub    $0x8,%esp
      76:	6a 64                	push   $0x64
      78:	68 60 1f 00 00       	push   $0x1f60
      7d:	e8 8e 00 00 00       	call   110 <getcmd>
      82:	83 c4 10             	add    $0x10,%esp
      85:	85 c0                	test   %eax,%eax
      87:	78 14                	js     9d <main+0x9d>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      89:	80 3d 60 1f 00 00 63 	cmpb   $0x63,0x1f60
      90:	75 c6                	jne    58 <main+0x58>
      92:	80 3d 61 1f 00 00 64 	cmpb   $0x64,0x1f61
      99:	75 bd                	jne    58 <main+0x58>
      9b:	eb ab                	jmp    48 <main+0x48>
  exit();
      9d:	e8 5b 11 00 00       	call   11fd <exit>
      buf[strlen(buf)-1] = 0;  // chop \n
      a2:	83 ec 0c             	sub    $0xc,%esp
      a5:	68 60 1f 00 00       	push   $0x1f60
      aa:	e8 01 0b 00 00       	call   bb0 <strlen>
      if(chdir(buf+3) < 0)
      af:	c7 04 24 63 1f 00 00 	movl   $0x1f63,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
      b6:	c6 80 5f 1f 00 00 00 	movb   $0x0,0x1f5f(%eax)
      if(chdir(buf+3) < 0)
      bd:	e8 ab 11 00 00       	call   126d <chdir>
      c2:	83 c4 10             	add    $0x10,%esp
      c5:	85 c0                	test   %eax,%eax
      c7:	79 aa                	jns    73 <main+0x73>
        printf(2, "cannot cd %s\n", buf+3);
      c9:	50                   	push   %eax
      ca:	68 63 1f 00 00       	push   $0x1f63
      cf:	68 b1 17 00 00       	push   $0x17b1
      d4:	6a 02                	push   $0x2
      d6:	e8 c5 12 00 00       	call   13a0 <printf>
      db:	83 c4 10             	add    $0x10,%esp
      de:	eb 93                	jmp    73 <main+0x73>
      close(fd);
      e0:	83 ec 0c             	sub    $0xc,%esp
      e3:	50                   	push   %eax
      e4:	e8 3c 11 00 00       	call   1225 <close>
      break;
      e9:	83 c4 10             	add    $0x10,%esp
      ec:	eb 85                	jmp    73 <main+0x73>
      runcmd(parsecmd(buf));
      ee:	83 ec 0c             	sub    $0xc,%esp
      f1:	68 60 1f 00 00       	push   $0x1f60
      f6:	e8 c5 09 00 00       	call   ac0 <parsecmd>
      fb:	89 04 24             	mov    %eax,(%esp)
      fe:	e8 7d 00 00 00       	call   180 <runcmd>
    panic("fork");
     103:	83 ec 0c             	sub    $0xc,%esp
     106:	68 32 17 00 00       	push   $0x1732
...
00000110 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     122:	68 08 17 00 00       	push   $0x1708
     127:	6a 02                	push   $0x2
     129:	e8 72 12 00 00       	call   13a0 <printf>
  memset(buf, 0, nbuf);
...
00000160 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     16d:	68 a5 17 00 00       	push   $0x17a5
     172:	6a 02                	push   $0x2
     174:	e8 27 12 00 00       	call   13a0 <printf>
  exit();
     179:	e8 7f 10 00 00       	call   11fd <exit>
...
00000180 <runcmd>:
{
  ...
  pid = fork();
     1d2:	e8 1e 10 00 00       	call   11f5 <fork>
  if(pid == -1)
    ...
    close(p[0]);
     ...
     1ee:	e8 32 10 00 00       	call   1225 <close>
    close(p[1]);
     1f3:	58                   	pop    %eax
     1f4:	ff 75 f4             	pushl  -0xc(%ebp)
     1f7:	e8 29 10 00 00       	call   1225 <close>
    wait();
     1fc:	e8 04 10 00 00       	call   1205 <wait>
    wait();
     201:	e8 ff 0f 00 00       	call   1205 <wait>
    break;
     206:	83 c4 10             	add    $0x10,%esp
     209:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
     210:	e8 e8 0f 00 00       	call   11fd <exit>
  pid = fork();
     215:	e8 db 0f 00 00       	call   11f5 <fork>
  if(pid == -1)
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     235:	52                   	push   %edx
     236:	50                   	push   %eax
     237:	e8 f9 0f 00 00       	call   1235 <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     23c:	83 c4 0c             	add    $0xc,%esp
     23f:	ff 73 04             	pushl  0x4(%ebx)
     242:	68 12 17 00 00       	push   $0x1712
     247:	6a 02                	push   $0x2
     249:	e8 52 11 00 00       	call   13a0 <printf>
    break;
     24e:	83 c4 10             	add    $0x10,%esp
     251:	eb bd                	jmp    210 <runcmd+0x90>
  pid = fork();
     253:	e8 9d 0f 00 00       	call   11f5 <fork>
  if(pid == -1)
    ...
    wait();
     265:	e8 9b 0f 00 00       	call   1205 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     27b:	e8 a5 0f 00 00       	call   1225 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     280:	58                   	pop    %eax
     281:	5a                   	pop    %edx
     282:	ff 73 10             	pushl  0x10(%ebx)
     285:	ff 73 08             	pushl  0x8(%ebx)
     288:	e8 b0 0f 00 00       	call   123d <open>
    ...
    panic("runcmd");
     ...
     2a2:	68 0b 17 00 00       	push   $0x170b
     2a7:	e8 b4 fe ff ff       	call   160 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2ac:	51                   	push   %ecx
     2ad:	ff 73 08             	pushl  0x8(%ebx)
     2b0:	68 22 17 00 00       	push   $0x1722
     2b5:	6a 02                	push   $0x2
     2b7:	e8 e4 10 00 00       	call   13a0 <printf>
      exit();
     2bc:	e8 3c 0f 00 00       	call   11fd <exit>
      panic("pipe");
     2c1:	83 ec 0c             	sub    $0xc,%esp
     2c4:	68 37 17 00 00       	push   $0x1737
     2c9:	e8 92 fe ff ff       	call   160 <panic>
      close(1);
     2ce:	83 ec 0c             	sub    $0xc,%esp
     2d1:	6a 01                	push   $0x1
     2d3:	e8 4d 0f 00 00       	call   1225 <close>
      dup(p[1]);
     2d8:	58                   	pop    %eax
     2d9:	ff 75 f4             	pushl  -0xc(%ebp)
     2dc:	e8 94 0f 00 00       	call   1275 <dup>
      close(p[0]);
     2e1:	58                   	pop    %eax
     2e2:	ff 75 f0             	pushl  -0x10(%ebp)
     2e5:	e8 3b 0f 00 00       	call   1225 <close>
      close(p[1]);
     2ea:	58                   	pop    %eax
     2eb:	ff 75 f4             	pushl  -0xc(%ebp)
     2ee:	e8 32 0f 00 00       	call   1225 <close>
      runcmd(pcmd->left);
     2f3:	5a                   	pop    %edx
     ...
     2ff:	6a 00                	push   $0x0
     301:	e8 1f 0f 00 00       	call   1225 <close>
      dup(p[0]);
     306:	5a                   	pop    %edx
     307:	ff 75 f0             	pushl  -0x10(%ebp)
     30a:	e8 66 0f 00 00       	call   1275 <dup>
      close(p[0]);
     30f:	59                   	pop    %ecx
     310:	ff 75 f0             	pushl  -0x10(%ebp)
     313:	e8 0d 0f 00 00       	call   1225 <close>
      close(p[1]);
     318:	58                   	pop    %eax
     319:	ff 75 f4             	pushl  -0xc(%ebp)
     31c:	e8 04 0f 00 00       	call   1225 <close>
      runcmd(pcmd->right);
     321:	58                   	pop    %eax
    ...
    panic("fork");
     ...
     32d:	68 32 17 00 00       	push   $0x1732
...
00000340 <fork1>:
{
  ...
  pid = fork();
     34a:	e8 a6 0e 00 00       	call   11f5 <fork>
  if(pid == -1)
  ...
  return pid;
    ...
    panic("fork");
     ...
     359:	68 32 17 00 00       	push   $0x1732
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     37b:	6a 54                	push   $0x54
     37d:	e8 7e 12 00 00       	call   1600 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3ab:	6a 18                	push   $0x18
     3ad:	e8 4e 12 00 00       	call   1600 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3fb:	6a 0c                	push   $0xc
     3fd:	e8 fe 11 00 00       	call   1600 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     43b:	6a 0c                	push   $0xc
     43d:	e8 be 11 00 00       	call   1600 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     47b:	6a 08                	push   $0x8
     47d:	e8 7e 11 00 00       	call   1600 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     4bd:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 4c 1f 00 00       	push   $0x1f4c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52d:	50                   	push   %eax
     52e:	68 4c 1f 00 00       	push   $0x1f4c
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     56e:	50                   	push   %eax
     56f:	68 44 1f 00 00       	push   $0x1f44
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     590:	56                   	push   %esi
     591:	68 4c 1f 00 00       	push   $0x1f4c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     63d:	50                   	push   %eax
     63e:	68 4c 1f 00 00       	push   $0x1f4c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     6ab:	68 59 17 00 00       	push   $0x1759
     6b0:	53                   	push   %ebx
     6b1:	56                   	push   %esi
  ...
  return cmd;
     ...
     736:	68 3c 17 00 00       	push   $0x173c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     753:	68 5c 17 00 00       	push   $0x175c
     758:	57                   	push   %edi
     759:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7a6:	68 73 17 00 00       	push   $0x1773
     7ab:	57                   	push   %edi
     7ac:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7f0:	68 65 17 00 00       	push   $0x1765
  ...
  cmd->eargv[argc] = 0;
     ...
     842:	68 5e 17 00 00       	push   $0x175e
...
00000850 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     86d:	68 78 17 00 00       	push   $0x1778
  cmd = parseexec(ps, es);
...
000008c0 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     903:	68 7a 17 00 00       	push   $0x177a
     908:	57                   	push   %edi
     909:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     919:	68 76 17 00 00       	push   $0x1776
     91e:	57                   	push   %edi
     91f:	56                   	push   %esi
...
00000970 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     983:	68 5c 17 00 00       	push   $0x175c
     988:	56                   	push   %esi
     989:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     9ad:	68 98 17 00 00       	push   $0x1798
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a1d:	3e ff 24 85 d8 17 00 	notrack jmp *0x17d8(,%eax,4)
     a24:	00 
...
00000ac0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     aeb:	68 21 17 00 00       	push   $0x1721
     af0:	53                   	push   %ebx
     af1:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b13:	52                   	push   %edx
     b14:	50                   	push   %eax
     b15:	68 9a 17 00 00       	push   $0x179a
     b1a:	6a 02                	push   $0x2
     b1c:	e8 7f 08 00 00       	call   13a0 <printf>
    panic("syntax");
     b21:	c7 04 24 5e 17 00 00 	movl   $0x175e,(%esp)
     ...
     c59:	31 f6                	xor    %esi,%esi
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c78:	50                   	push   %eax
     c79:	6a 00                	push   $0x0
     c7b:	e8 95 05 00 00       	call   1215 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     ce1:	e8 57 05 00 00       	call   123d <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cf5:	50                   	push   %eax
     cf6:	e8 5a 05 00 00       	call   1255 <fstat>
  close(fd);
     cfb:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     cfe:	89 c6                	mov    %eax,%esi
  close(fd);
     d00:	e8 20 05 00 00       	call   1225 <close>
  return r;
...
hexdump (void *data, size_t size) {
  ...
  printf(1, "+------+-------------------------------------------------+------------------+\n");
     da0:	68 f0 17 00 00       	push   $0x17f0
hexdump (void *data, size_t size) {
     da5:	89 45 e0             	mov    %eax,-0x20(%ebp)
...
hexdump (void *data, size_t size) {
  ...
  printf(1, "+------+-------------------------------------------------+------------------+\n");
     db2:	e8 e9 05 00 00       	call   13a0 <printf>
  for (offset = 0; offset < size; offset += 16) {
     db7:	83 c4 10             	add    $0x10,%esp
     dba:	85 ff                	test   %edi,%edi
     dbc:	0f 84 2d 01 00 00    	je     eef <hexdump+0x15f>
     dc2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
     dc5:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
     dcc:	be 10 00 00 00       	mov    $0x10,%esi
     dd1:	83 e8 01             	sub    $0x1,%eax
     dd4:	83 e0 f0             	and    $0xfffffff0,%eax
     dd7:	83 c0 10             	add    $0x10,%eax
     dda:	89 45 d4             	mov    %eax,-0x2c(%ebp)
     ddd:	8d 76 00             	lea    0x0(%esi),%esi
    printf(1, "| ");
     de0:	83 ec 08             	sub    $0x8,%esp
     de3:	68 44 18 00 00       	push   $0x1844
     de8:	6a 01                	push   $0x1
     dea:	e8 b1 05 00 00       	call   13a0 <printf>
    if (offset <= 0x0fff) printf(1, "0");
     def:	83 c4 10             	add    $0x10,%esp
     df2:	81 7d dc ff 0f 00 00 	cmpl   $0xfff,-0x24(%ebp)
     df9:	0f 8e 51 01 00 00    	jle    f50 <hexdump+0x1c0>
    if (offset <= 0x00ff) printf(1, "0");
    if (offset <= 0x000f) printf(1, "0");
    printf(1, "%x | ", offset);
     dff:	8b 7d dc             	mov    -0x24(%ebp),%edi
     e02:	83 ec 04             	sub    $0x4,%esp
     e05:	57                   	push   %edi
     e06:	89 fb                	mov    %edi,%ebx
     e08:	68 41 18 00 00       	push   $0x1841
     e0d:	6a 01                	push   $0x1
     e0f:	e8 8c 05 00 00       	call   13a0 <printf>
     e14:	89 7d d8             	mov    %edi,-0x28(%ebp)
     e17:	83 c4 10             	add    $0x10,%esp
     e1a:	8b 7d e0             	mov    -0x20(%ebp),%edi
     e1d:	eb 28                	jmp    e47 <hexdump+0xb7>
     e1f:	90                   	nop
    for (index = 0; index < 16; index++) {
      if(offset + index < (int)size) {
        if (src[offset + index] <= 0x0f) printf(1, "0");
     e20:	0f b6 14 1f          	movzbl (%edi,%ebx,1),%edx
     e24:	80 fa 0f             	cmp    $0xf,%dl
     e27:	0f 86 e3 00 00 00    	jbe    f10 <hexdump+0x180>
        printf(1, "%x ", 0xff & src[offset + index]);
     e2d:	83 ec 04             	sub    $0x4,%esp
     e30:	83 c3 01             	add    $0x1,%ebx
     e33:	52                   	push   %edx
     e34:	68 47 18 00 00       	push   $0x1847
     e39:	6a 01                	push   $0x1
     e3b:	e8 60 05 00 00       	call   13a0 <printf>
     e40:	83 c4 10             	add    $0x10,%esp
    for (index = 0; index < 16; index++) {
     e43:	39 f3                	cmp    %esi,%ebx
     e45:	74 1e                	je     e65 <hexdump+0xd5>
      if(offset + index < (int)size) {
     e47:	39 5d e4             	cmp    %ebx,-0x1c(%ebp)
     e4a:	7f d4                	jg     e20 <hexdump+0x90>
      } else {
        printf(1, "   ");
     e4c:	83 ec 08             	sub    $0x8,%esp
     e4f:	83 c3 01             	add    $0x1,%ebx
     e52:	68 4b 18 00 00       	push   $0x184b
     e57:	6a 01                	push   $0x1
     e59:	e8 42 05 00 00       	call   13a0 <printf>
     e5e:	83 c4 10             	add    $0x10,%esp
    for (index = 0; index < 16; index++) {
     e61:	39 f3                	cmp    %esi,%ebx
     e63:	75 e2                	jne    e47 <hexdump+0xb7>
      }
    }
    printf(1, "| ");
     e65:	83 ec 08             	sub    $0x8,%esp
     e68:	8b 5d d8             	mov    -0x28(%ebp),%ebx
     e6b:	68 44 18 00 00       	push   $0x1844
     e70:	6a 01                	push   $0x1
     e72:	e8 29 05 00 00       	call   13a0 <printf>
     e77:	8b 7d e4             	mov    -0x1c(%ebp),%edi
     e7a:	83 c4 10             	add    $0x10,%esp
     e7d:	eb 1b                	jmp    e9a <hexdump+0x10a>
     e7f:	90                   	nop
    for(index = 0; index < 16; index++) {
      if(offset + index < (int)size) {
     ...
     e83:	52                   	push   %edx
     e84:	68 4f 18 00 00       	push   $0x184f
     e89:	6a 01                	push   $0x1
     e8b:	e8 10 05 00 00       	call   13a0 <printf>
     e90:	83 c4 10             	add    $0x10,%esp
    for(index = 0; index < 16; index++) {
     e93:	83 c3 01             	add    $0x1,%ebx
     e96:	39 de                	cmp    %ebx,%esi
     e98:	74 30                	je     eca <hexdump+0x13a>
      if(offset + index < (int)size) {
     e9a:	39 df                	cmp    %ebx,%edi
     e9c:	0f 8e 8e 00 00 00    	jle    f30 <hexdump+0x1a0>
        if(isascii(src[offset + index]) && isprint(src[offset + index])) {
     ea2:	8b 45 e0             	mov    -0x20(%ebp),%eax
     ea5:	0f b6 14 18          	movzbl (%eax,%ebx,1),%edx
     ea9:	8d 4a e0             	lea    -0x20(%edx),%ecx
     eac:	80 f9 5e             	cmp    $0x5e,%cl
     eaf:	76 cf                	jbe    e80 <hexdump+0xf0>
        } else {
          printf(1, ".");
     eb1:	83 ec 08             	sub    $0x8,%esp
     eb4:	83 c3 01             	add    $0x1,%ebx
     eb7:	68 52 18 00 00       	push   $0x1852
     ebc:	6a 01                	push   $0x1
     ebe:	e8 dd 04 00 00       	call   13a0 <printf>
     ec3:	83 c4 10             	add    $0x10,%esp
    for(index = 0; index < 16; index++) {
     ec6:	39 de                	cmp    %ebx,%esi
     ec8:	75 d0                	jne    e9a <hexdump+0x10a>
        }
      } else {
        printf(1, " ");
      }
    ...
    printf(1, " |\n");
     eca:	83 ec 08             	sub    $0x8,%esp
     ecd:	83 c6 10             	add    $0x10,%esi
     ed0:	68 54 18 00 00       	push   $0x1854
     ed5:	6a 01                	push   $0x1
     ed7:	e8 c4 04 00 00       	call   13a0 <printf>
  for (offset = 0; offset < size; offset += 16) {
     edc:	83 45 dc 10          	addl   $0x10,-0x24(%ebp)
     ee0:	83 c4 10             	add    $0x10,%esp
     ee3:	8b 45 dc             	mov    -0x24(%ebp),%eax
     ee6:	3b 45 d4             	cmp    -0x2c(%ebp),%eax
     ee9:	0f 85 f1 fe ff ff    	jne    de0 <hexdump+0x50>
  }
  printf(1, "+------+-------------------------------------------------+------------------+\n");
     eef:	c7 45 0c f0 17 00 00 	movl   $0x17f0,0xc(%ebp)
     ef6:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
     ...
     f03:	5d                   	pop    %ebp
  printf(1, "+------+-------------------------------------------------+------------------+\n");
     f04:	e9 97 04 00 00       	jmp    13a0 <printf>
     f09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        if (src[offset + index] <= 0x0f) printf(1, "0");
     f10:	83 ec 08             	sub    $0x8,%esp
     f13:	68 3f 18 00 00       	push   $0x183f
     f18:	6a 01                	push   $0x1
     f1a:	e8 81 04 00 00       	call   13a0 <printf>
     f1f:	0f b6 14 1f          	movzbl (%edi,%ebx,1),%edx
     f23:	83 c4 10             	add    $0x10,%esp
     f26:	e9 02 ff ff ff       	jmp    e2d <hexdump+0x9d>
     f2b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
     f2f:	90                   	nop
        printf(1, " ");
     f30:	83 ec 08             	sub    $0x8,%esp
     f33:	68 4d 18 00 00       	push   $0x184d
     f38:	6a 01                	push   $0x1
     f3a:	e8 61 04 00 00       	call   13a0 <printf>
     f3f:	83 c4 10             	add    $0x10,%esp
     f42:	e9 4c ff ff ff       	jmp    e93 <hexdump+0x103>
     f47:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     f4e:	66 90                	xchg   %ax,%ax
    if (offset <= 0x0fff) printf(1, "0");
     f50:	83 ec 08             	sub    $0x8,%esp
     f53:	68 3f 18 00 00       	push   $0x183f
     f58:	6a 01                	push   $0x1
     f5a:	e8 41 04 00 00       	call   13a0 <printf>
    if (offset <= 0x00ff) printf(1, "0");
     f5f:	8b 7d dc             	mov    -0x24(%ebp),%edi
     f62:	83 c4 10             	add    $0x10,%esp
     f65:	81 ff ff 00 00 00    	cmp    $0xff,%edi
     f6b:	0f 8f 8e fe ff ff    	jg     dff <hexdump+0x6f>
     f71:	83 ec 08             	sub    $0x8,%esp
     f74:	68 3f 18 00 00       	push   $0x183f
     f79:	6a 01                	push   $0x1
     f7b:	e8 20 04 00 00       	call   13a0 <printf>
    if (offset <= 0x000f) printf(1, "0");
     f80:	83 c4 10             	add    $0x10,%esp
     f83:	83 ff 0f             	cmp    $0xf,%edi
     f86:	0f 8f 73 fe ff ff    	jg     dff <hexdump+0x6f>
     f8c:	83 ec 08             	sub    $0x8,%esp
     f8f:	68 3f 18 00 00       	push   $0x183f
     f94:	6a 01                	push   $0x1
     f96:	e8 05 04 00 00       	call   13a0 <printf>
     f9b:	83 c4 10             	add    $0x10,%esp
     f9e:	e9 5c fe ff ff       	jmp    dff <hexdump+0x6f>
     fa3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
hton16 (uint16_t h)
{
     ...
     fb4:	55                   	push   %ebp
    if (!endian)
     fb5:	a1 c4 1f 00 00       	mov    0x1fc4,%eax
{
     fba:	89 e5                	mov    %esp,%ebp
     fbc:	8b 4d 08             	mov    0x8(%ebp),%ecx
    if (!endian)
     fbf:	85 c0                	test   %eax,%eax
     fc1:	75 1d                	jne    fe0 <hton16+0x30>
        endian = byteorder();
     fc3:	c7 05 c4 1f 00 00 d2 	movl   $0x4d2,0x1fc4
     fca:	04 00 00 
    return (v & 0x00ff) << 8 | (v & 0xff00 ) >> 8;
     fcd:	89 ca                	mov    %ecx,%edx
    return endian == __LITTLE_ENDIAN ? byteswap16(h) : h;
}
     fcf:	5d                   	pop    %ebp
     fd0:	66 c1 c2 08          	rol    $0x8,%dx
    ...
    return endian == __LITTLE_ENDIAN ? byteswap16(h) : h;
     fe2:	3d d2 04 00 00       	cmp    $0x4d2,%eax
     fe7:	74 e4                	je     fcd <hton16+0x1d>
}
     fe9:	89 d0                	mov    %edx,%eax
     feb:	5d                   	pop    %ebp
     fec:	c3                   	ret    
...
hton32(uint32_t h)
{
    ...
    1004:	55                   	push   %ebp
    if (!endian)
    1005:	8b 15 c4 1f 00 00    	mov    0x1fc4,%edx
{
    100b:	89 e5                	mov    %esp,%ebp
    100d:	8b 45 08             	mov    0x8(%ebp),%eax
    if (!endian)
    1010:	85 d2                	test   %edx,%edx
    1012:	75 14                	jne    1028 <hton32+0x28>
        endian = byteorder();
    1014:	c7 05 c4 1f 00 00 d2 	movl   $0x4d2,0x1fc4
    101b:	04 00 00 
    return (v & 0x000000ff) << 24 | (v & 0x0000ff00) << 8 | (v & 0x00ff0000) >> 8 | (v & 0xff000000) >> 24;
    101e:	0f c8                	bswap  %eax
    ...
    return endian == __LITTLE_ENDIAN ? byteswap32(h) : h;
    1028:	81 fa d2 04 00 00    	cmp    $0x4d2,%edx
    102e:	74 ee                	je     101e <hton32+0x1e>
}
    1030:	5d                   	pop    %ebp
    1031:	c3                   	ret    
    1032:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1039:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00001040 <ntoh32>:
    1040:	f3 0f 1e fb          	endbr32 
    1044:	eb ba                	jmp    1000 <hton32>
...
strtol(const char *s, char **endptr, int base)
{
    ...
    105b:	56                   	push   %esi
    105c:	53                   	push   %ebx
    105d:	8b 5d 10             	mov    0x10(%ebp),%ebx
    int neg = 0;
    long val = 0;
    ...
    1063:	3c 09                	cmp    $0x9,%al
    1065:	74 09                	je     1070 <strtol+0x20>
    1067:	3c 20                	cmp    $0x20,%al
    1069:	75 14                	jne    107f <strtol+0x2f>
    ...
    while (*s == ' ' || *s == '\t')
    1077:	3c 20                	cmp    $0x20,%al
    1079:	74 f5                	je     1070 <strtol+0x20>
    107b:	3c 09                	cmp    $0x9,%al
    107d:	74 f1                	je     1070 <strtol+0x20>

    // plus/minus sign
    if (*s == '+')
    107f:	3c 2b                	cmp    $0x2b,%al
    1081:	0f 84 a9 00 00 00    	je     1130 <strtol+0xe0>
    int neg = 0;
    1087:	31 ff                	xor    %edi,%edi
        s++;
    else if (*s == '-')
    1089:	3c 2d                	cmp    $0x2d,%al
    108b:	0f 84 8f 00 00 00    	je     1120 <strtol+0xd0>
        s++, neg = 1;

    // hex or octal base prefix
    if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
    1091:	0f be 11             	movsbl (%ecx),%edx
    1094:	f7 c3 ef ff ff ff    	test   $0xffffffef,%ebx
    109a:	75 12                	jne    10ae <strtol+0x5e>
    109c:	80 fa 30             	cmp    $0x30,%dl
    109f:	0f 84 9b 00 00 00    	je     1140 <strtol+0xf0>
        s += 2, base = 16;
    else if (base == 0 && s[0] == '0')
    10a5:	85 db                	test   %ebx,%ebx
    10a7:	75 05                	jne    10ae <strtol+0x5e>
        s++, base = 8;
    else if (base == 0)
        base = 10;
    10a9:	bb 0a 00 00 00       	mov    $0xa,%ebx
    10ae:	89 5d 10             	mov    %ebx,0x10(%ebp)
    10b1:	31 c0                	xor    %eax,%eax
    10b3:	eb 17                	jmp    10cc <strtol+0x7c>
    ...
    10b8:	83 ea 30             	sub    $0x30,%edx
            ...
            break;
        if (dig >= base)
    10bb:	3b 55 10             	cmp    0x10(%ebp),%edx
    10be:	7d 28                	jge    10e8 <strtol+0x98>
            break;
        s++, val = (val * base) + dig;
    10c0:	0f af 45 10          	imul   0x10(%ebp),%eax
    10c4:	83 c1 01             	add    $0x1,%ecx
    10c7:	01 d0                	add    %edx,%eax
    while (1) {
    10c9:	0f be 11             	movsbl (%ecx),%edx
        if (*s >= '0' && *s <= '9')
    10cc:	8d 72 d0             	lea    -0x30(%edx),%esi
    10cf:	89 f3                	mov    %esi,%ebx
    10d1:	80 fb 09             	cmp    $0x9,%bl
    10d4:	76 e2                	jbe    10b8 <strtol+0x68>
        else if (*s >= 'a' && *s <= 'z')
    10d6:	8d 72 9f             	lea    -0x61(%edx),%esi
    10d9:	89 f3                	mov    %esi,%ebx
    10db:	80 fb 19             	cmp    $0x19,%bl
    10de:	77 28                	ja     1108 <strtol+0xb8>
            dig = *s - 'a' + 10;
    10e0:	83 ea 57             	sub    $0x57,%edx
        if (dig >= base)
    10e3:	3b 55 10             	cmp    0x10(%ebp),%edx
    10e6:	7c d8                	jl     10c0 <strtol+0x70>
    ...
    10ed:	74 05                	je     10f4 <strtol+0xa4>
        *endptr = (char *) s;
    10ef:	8b 75 0c             	mov    0xc(%ebp),%esi
    10f2:	89 0e                	mov    %ecx,(%esi)
    return (neg ? -val : val);
    10f4:	89 c2                	mov    %eax,%edx
}
    10f6:	5b                   	pop    %ebx
    10f7:	5e                   	pop    %esi
    return (neg ? -val : val);
    ...
    10fd:	5d                   	pop    %ebp
    return (neg ? -val : val);
    10fe:	0f 45 c2             	cmovne %edx,%eax
}
    1101:	c3                   	ret    
    1102:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        else if (*s >= 'A' && *s <= 'Z')
    1108:	8d 72 bf             	lea    -0x41(%edx),%esi
    110b:	89 f3                	mov    %esi,%ebx
    110d:	80 fb 19             	cmp    $0x19,%bl
    1110:	77 d6                	ja     10e8 <strtol+0x98>
            dig = *s - 'A' + 10;
    1112:	83 ea 37             	sub    $0x37,%edx
    1115:	eb a4                	jmp    10bb <strtol+0x6b>
    1117:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    111e:	66 90                	xchg   %ax,%ax
        s++, neg = 1;
    1120:	83 c1 01             	add    $0x1,%ecx
    1123:	bf 01 00 00 00       	mov    $0x1,%edi
    1128:	e9 64 ff ff ff       	jmp    1091 <strtol+0x41>
    112d:	8d 76 00             	lea    0x0(%esi),%esi
        s++;
    1130:	83 c1 01             	add    $0x1,%ecx
    int neg = 0;
    1133:	31 ff                	xor    %edi,%edi
    1135:	e9 57 ff ff ff       	jmp    1091 <strtol+0x41>
    113a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x'))
    1140:	0f b6 41 01          	movzbl 0x1(%ecx),%eax
    1144:	3c 78                	cmp    $0x78,%al
    1146:	74 18                	je     1160 <strtol+0x110>
    else if (base == 0 && s[0] == '0')
    1148:	85 db                	test   %ebx,%ebx
    114a:	0f 85 5e ff ff ff    	jne    10ae <strtol+0x5e>
        s++, base = 8;
    1150:	83 c1 01             	add    $0x1,%ecx
    1153:	0f be d0             	movsbl %al,%edx
    1156:	bb 08 00 00 00       	mov    $0x8,%ebx
    115b:	e9 4e ff ff ff       	jmp    10ae <strtol+0x5e>
        s += 2, base = 16;
    1160:	0f be 51 02          	movsbl 0x2(%ecx),%edx
    1164:	bb 10 00 00 00       	mov    $0x10,%ebx
    1169:	83 c1 02             	add    $0x2,%ecx
    116c:	e9 3d ff ff ff       	jmp    10ae <strtol+0x5e>
    1171:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1178:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    117f:	90                   	nop

00001180 <ip_addr_pton>:
...
ip_addr_pton (const char *p, ip_addr_t *n) {
    ...
    sp = (char *)p;
    for (idx = 0; idx < 4; idx++) {
    1188:	31 ff                	xor    %edi,%edi
ip_addr_pton (const char *p, ip_addr_t *n) {
    118a:	56                   	push   %esi
    118b:	53                   	push   %ebx
    118c:	8d 5d e4             	lea    -0x1c(%ebp),%ebx
    118f:	83 ec 1c             	sub    $0x1c,%esp
    1192:	8b 75 08             	mov    0x8(%ebp),%esi
        ret = strtol(sp, &ep, 10);
    1195:	83 ec 04             	sub    $0x4,%esp
    1198:	6a 0a                	push   $0xa
    119a:	53                   	push   %ebx
    119b:	56                   	push   %esi
    119c:	e8 af fe ff ff       	call   1050 <strtol>
        if (ret < 0 || ret > 255) {
    11a1:	83 c4 10             	add    $0x10,%esp
    11a4:	3d ff 00 00 00       	cmp    $0xff,%eax
    11a9:	77 3d                	ja     11e8 <ip_addr_pton+0x68>
            return -1;
        }
        if (ep == sp) {
    11ab:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
    11ae:	39 f1                	cmp    %esi,%ecx
    11b0:	74 36                	je     11e8 <ip_addr_pton+0x68>
            return -1;
        }
        if ((idx == 3 && *ep != '\0') || (idx != 3 && *ep != '.')) {
    11b2:	0f b6 11             	movzbl (%ecx),%edx
    11b5:	83 ff 03             	cmp    $0x3,%edi
    11b8:	74 16                	je     11d0 <ip_addr_pton+0x50>
    11ba:	80 fa 2e             	cmp    $0x2e,%dl
    11bd:	75 29                	jne    11e8 <ip_addr_pton+0x68>
            return -1;
        }
        ((uint8_t *)n)[idx] = ret;
    11bf:	8b 55 0c             	mov    0xc(%ebp),%edx
        sp = ep + 1;
    11c2:	8d 71 01             	lea    0x1(%ecx),%esi
        ((uint8_t *)n)[idx] = ret;
    11c5:	88 04 3a             	mov    %al,(%edx,%edi,1)
    for (idx = 0; idx < 4; idx++) {
    11c8:	83 c7 01             	add    $0x1,%edi
    11cb:	eb c8                	jmp    1195 <ip_addr_pton+0x15>
    11cd:	8d 76 00             	lea    0x0(%esi),%esi
        if ((idx == 3 && *ep != '\0') || (idx != 3 && *ep != '.')) {
    11d0:	84 d2                	test   %dl,%dl
    11d2:	75 14                	jne    11e8 <ip_addr_pton+0x68>
        ((uint8_t *)n)[idx] = ret;
    11d4:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    11d7:	88 43 03             	mov    %al,0x3(%ebx)
    }
    return 0;
}
    ...
    11e8:	8d 65 f4             	lea    -0xc(%ebp),%esp
            return -1;
    11eb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    11f0:	5b                   	pop    %ebx
    11f1:	5e                   	pop    %esi
    11f2:	5f                   	pop    %edi
...
000011fd <exit>:
SYSCALL(exit)
    11fd:	b8 02 00 00 00       	mov    $0x2,%eax
    1202:	cd 40                	int    $0x40
    1204:	c3                   	ret    

00001205 <wait>:
SYSCALL(wait)
    1205:	b8 03 00 00 00       	mov    $0x3,%eax
    120a:	cd 40                	int    $0x40
    120c:	c3                   	ret    

0000120d <pipe>:
SYSCALL(pipe)
    120d:	b8 04 00 00 00       	mov    $0x4,%eax
    1212:	cd 40                	int    $0x40
    1214:	c3                   	ret    

00001215 <read>:
SYSCALL(read)
    1215:	b8 05 00 00 00       	mov    $0x5,%eax
    121a:	cd 40                	int    $0x40
    121c:	c3                   	ret    

0000121d <write>:
SYSCALL(write)
    121d:	b8 10 00 00 00       	mov    $0x10,%eax
    1222:	cd 40                	int    $0x40
    1224:	c3                   	ret    

00001225 <close>:
SYSCALL(close)
    1225:	b8 15 00 00 00       	mov    $0x15,%eax
    122a:	cd 40                	int    $0x40
    122c:	c3                   	ret    

0000122d <kill>:
SYSCALL(kill)
    122d:	b8 06 00 00 00       	mov    $0x6,%eax
    1232:	cd 40                	int    $0x40
    1234:	c3                   	ret    

00001235 <exec>:
SYSCALL(exec)
    1235:	b8 07 00 00 00       	mov    $0x7,%eax
    123a:	cd 40                	int    $0x40
    123c:	c3                   	ret    

0000123d <open>:
SYSCALL(open)
    123d:	b8 0f 00 00 00       	mov    $0xf,%eax
    1242:	cd 40                	int    $0x40
    1244:	c3                   	ret    

00001245 <mknod>:
SYSCALL(mknod)
    1245:	b8 11 00 00 00       	mov    $0x11,%eax
    124a:	cd 40                	int    $0x40
    124c:	c3                   	ret    

0000124d <unlink>:
SYSCALL(unlink)
    124d:	b8 12 00 00 00       	mov    $0x12,%eax
    1252:	cd 40                	int    $0x40
    1254:	c3                   	ret    

00001255 <fstat>:
SYSCALL(fstat)
    1255:	b8 08 00 00 00       	mov    $0x8,%eax
    125a:	cd 40                	int    $0x40
    125c:	c3                   	ret    

0000125d <link>:
SYSCALL(link)
    125d:	b8 13 00 00 00       	mov    $0x13,%eax
    1262:	cd 40                	int    $0x40
    1264:	c3                   	ret    

00001265 <mkdir>:
SYSCALL(mkdir)
    1265:	b8 14 00 00 00       	mov    $0x14,%eax
    126a:	cd 40                	int    $0x40
    126c:	c3                   	ret    

0000126d <chdir>:
SYSCALL(chdir)
    126d:	b8 09 00 00 00       	mov    $0x9,%eax
    1272:	cd 40                	int    $0x40
    1274:	c3                   	ret    

00001275 <dup>:
SYSCALL(dup)
    1275:	b8 0a 00 00 00       	mov    $0xa,%eax
    127a:	cd 40                	int    $0x40
    127c:	c3                   	ret    

0000127d <getpid>:
SYSCALL(getpid)
    127d:	b8 0b 00 00 00       	mov    $0xb,%eax
    1282:	cd 40                	int    $0x40
    1284:	c3                   	ret    

00001285 <sbrk>:
SYSCALL(sbrk)
    1285:	b8 0c 00 00 00       	mov    $0xc,%eax
    128a:	cd 40                	int    $0x40
    128c:	c3                   	ret    

0000128d <sleep>:
SYSCALL(sleep)
    128d:	b8 0d 00 00 00       	mov    $0xd,%eax
    1292:	cd 40                	int    $0x40
    1294:	c3                   	ret    

00001295 <uptime>:
SYSCALL(uptime)
    1295:	b8 0e 00 00 00       	mov    $0xe,%eax
    129a:	cd 40                	int    $0x40
    129c:	c3                   	ret    
...
# iotcl
SYSCALL(ioctl)
    129d:	b8 16 00 00 00       	mov    $0x16,%eax
    12a2:	cd 40                	int    $0x40
    12a4:	c3                   	ret    
...
# socket
SYSCALL(socket)
    12a5:	b8 17 00 00 00       	mov    $0x17,%eax
    12aa:	cd 40                	int    $0x40
    12ac:	c3                   	ret    

000012ad <bind>:
SYSCALL(bind)
    12ad:	b8 19 00 00 00       	mov    $0x19,%eax
    12b2:	cd 40                	int    $0x40
    12b4:	c3                   	ret    

000012b5 <listen>:
SYSCALL(listen)
    12b5:	b8 1a 00 00 00       	mov    $0x1a,%eax
    12ba:	cd 40                	int    $0x40
    12bc:	c3                   	ret    

000012bd <accept>:
SYSCALL(accept)
    12bd:	b8 1b 00 00 00       	mov    $0x1b,%eax
    12c2:	cd 40                	int    $0x40
    12c4:	c3                   	ret    

000012c5 <recv>:
SYSCALL(recv)
    12c5:	b8 1c 00 00 00       	mov    $0x1c,%eax
    12ca:	cd 40                	int    $0x40
    12cc:	c3                   	ret    

000012cd <send>:
SYSCALL(send)
    12cd:	b8 1d 00 00 00       	mov    $0x1d,%eax
    12d2:	cd 40                	int    $0x40
    12d4:	c3                   	ret    

000012d5 <recvfrom>:
SYSCALL(recvfrom)
    12d5:	b8 1e 00 00 00       	mov    $0x1e,%eax
    12da:	cd 40                	int    $0x40
    12dc:	c3                   	ret    

000012dd <sendto>:
SYSCALL(sendto)
    12dd:	b8 1f 00 00 00       	mov    $0x1f,%eax
    12e2:	cd 40                	int    $0x40
    12e4:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    12f4:	56                   	push   %esi
    12f5:	53                   	push   %ebx
    12f6:	83 ec 3c             	sub    $0x3c,%esp
    12f9:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
...
{
    12fe:	89 45 b8             	mov    %eax,-0x48(%ebp)
  if(sgn && xx < 0){
    1301:	85 d2                	test   %edx,%edx
    1303:	0f 89 7f 00 00 00    	jns    1388 <printint+0x98>
    1309:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    130d:	74 79                	je     1388 <printint+0x98>
    neg = 1;
    130f:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    x = -xx;
    1316:	f7 d9                	neg    %ecx
  } else {
    x = xx;
  ...
  i = 0;
    ...
    131a:	8d 75 d7             	lea    -0x29(%ebp),%esi
  ...
  do{
    ...
    1326:	f7 75 c4             	divl   -0x3c(%ebp)
    1329:	0f b6 92 60 18 00 00 	movzbl 0x1860(%edx),%edx
    1330:	89 45 c0             	mov    %eax,-0x40(%ebp)
    1333:	89 d8                	mov    %ebx,%eax
    1335:	8d 5b 01             	lea    0x1(%ebx),%ebx
  }while((x /= base) != 0);
    1338:	8b 4d c0             	mov    -0x40(%ebp),%ecx
    buf[i++] = digits[x % base];
    133b:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
    133e:	39 7d c4             	cmp    %edi,-0x3c(%ebp)
    1341:	76 dd                	jbe    1320 <printint+0x30>
  if(neg)
    1343:	8b 4d bc             	mov    -0x44(%ebp),%ecx
    1346:	85 c9                	test   %ecx,%ecx
    1348:	74 0c                	je     1356 <printint+0x66>
    buf[i++] = '-';
    134a:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    buf[i++] = digits[x % base];
    134f:	89 d8                	mov    %ebx,%eax
    buf[i++] = '-';
    1351:	ba 2d 00 00 00       	mov    $0x2d,%edx

  while(--i >= 0)
    1356:	8b 7d b8             	mov    -0x48(%ebp),%edi
    1359:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    135d:	eb 07                	jmp    1366 <printint+0x76>
    135f:	90                   	nop
    1360:	0f b6 13             	movzbl (%ebx),%edx
    1363:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
    1366:	83 ec 04             	sub    $0x4,%esp
    1369:	88 55 d7             	mov    %dl,-0x29(%ebp)
    136c:	6a 01                	push   $0x1
    136e:	56                   	push   %esi
    136f:	57                   	push   %edi
    1370:	e8 a8 fe ff ff       	call   121d <write>
  while(--i >= 0)
    1375:	83 c4 10             	add    $0x10,%esp
    1378:	39 de                	cmp    %ebx,%esi
    137a:	75 e4                	jne    1360 <printint+0x70>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
    1388:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
    138f:	eb 87                	jmp    1318 <printint+0x28>
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    13ad:	8b 75 0c             	mov    0xc(%ebp),%esi
    13b0:	0f b6 1e             	movzbl (%esi),%ebx
    13b3:	84 db                	test   %bl,%bl
    13b5:	0f 84 b4 00 00 00    	je     146f <printf+0xcf>
  ap = (uint*)(void*)&fmt + 1;
    13bb:	8d 45 10             	lea    0x10(%ebp),%eax
    13be:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
    13c1:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    13c4:	31 d2                	xor    %edx,%edx
  ap = (uint*)(void*)&fmt + 1;
    13c6:	89 45 d0             	mov    %eax,-0x30(%ebp)
    13c9:	eb 33                	jmp    13fe <printf+0x5e>
    13cb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    13cf:	90                   	nop
    13d0:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    13d3:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    13d8:	83 f8 25             	cmp    $0x25,%eax
    13db:	74 17                	je     13f4 <printf+0x54>
  write(fd, &c, 1);
    13dd:	83 ec 04             	sub    $0x4,%esp
    13e0:	88 5d e7             	mov    %bl,-0x19(%ebp)
    13e3:	6a 01                	push   $0x1
    13e5:	57                   	push   %edi
    13e6:	ff 75 08             	pushl  0x8(%ebp)
    13e9:	e8 2f fe ff ff       	call   121d <write>
    13ee:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    13f1:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    13f4:	0f b6 1e             	movzbl (%esi),%ebx
    13f7:	83 c6 01             	add    $0x1,%esi
    13fa:	84 db                	test   %bl,%bl
    13fc:	74 71                	je     146f <printf+0xcf>
    c = fmt[i] & 0xff;
    13fe:	0f be cb             	movsbl %bl,%ecx
    1401:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    1404:	85 d2                	test   %edx,%edx
    1406:	74 c8                	je     13d0 <printf+0x30>
      }
    } else if(state == '%'){
    1408:	83 fa 25             	cmp    $0x25,%edx
    140b:	75 e7                	jne    13f4 <printf+0x54>
      if(c == 'd'){
    140d:	83 f8 64             	cmp    $0x64,%eax
    1410:	0f 84 9a 00 00 00    	je     14b0 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    1416:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    141c:	83 f9 70             	cmp    $0x70,%ecx
    141f:	74 5f                	je     1480 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    1421:	83 f8 73             	cmp    $0x73,%eax
    1424:	0f 84 d6 00 00 00    	je     1500 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    142a:	83 f8 63             	cmp    $0x63,%eax
    142d:	0f 84 8d 00 00 00    	je     14c0 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    1433:	83 f8 25             	cmp    $0x25,%eax
    1436:	0f 84 b4 00 00 00    	je     14f0 <printf+0x150>
  write(fd, &c, 1);
    143c:	83 ec 04             	sub    $0x4,%esp
    143f:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    1443:	6a 01                	push   $0x1
    1445:	57                   	push   %edi
    1446:	ff 75 08             	pushl  0x8(%ebp)
    1449:	e8 cf fd ff ff       	call   121d <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    144e:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
    1451:	83 c4 0c             	add    $0xc,%esp
    1454:	6a 01                	push   $0x1
    1456:	83 c6 01             	add    $0x1,%esi
    1459:	57                   	push   %edi
    145a:	ff 75 08             	pushl  0x8(%ebp)
    145d:	e8 bb fd ff ff       	call   121d <write>
  for(i = 0; fmt[i]; i++){
    ...
    1466:	83 c4 10             	add    $0x10,%esp
      ...
      state = 0;
    1469:	31 d2                	xor    %edx,%edx
  for(i = 0; fmt[i]; i++){
    146b:	84 db                	test   %bl,%bl
    146d:	75 8f                	jne    13fe <printf+0x5e>
    }
  }
}
    146f:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1472:	5b                   	pop    %ebx
    1473:	5e                   	pop    %esi
    1474:	5f                   	pop    %edi
    1475:	5d                   	pop    %ebp
    1476:	c3                   	ret    
    1477:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    147e:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 16, 0);
    1480:	83 ec 0c             	sub    $0xc,%esp
    1483:	b9 10 00 00 00       	mov    $0x10,%ecx
    1488:	6a 00                	push   $0x0
    148a:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    148d:	8b 45 08             	mov    0x8(%ebp),%eax
    1490:	8b 13                	mov    (%ebx),%edx
    1492:	e8 59 fe ff ff       	call   12f0 <printint>
        ap++;
    1497:	89 d8                	mov    %ebx,%eax
    1499:	83 c4 10             	add    $0x10,%esp
      state = 0;
    149c:	31 d2                	xor    %edx,%edx
        ap++;
    149e:	83 c0 04             	add    $0x4,%eax
    14a1:	89 45 d0             	mov    %eax,-0x30(%ebp)
    14a4:	e9 4b ff ff ff       	jmp    13f4 <printf+0x54>
    14a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printint(fd, *ap, 10, 1);
    14b0:	83 ec 0c             	sub    $0xc,%esp
    14b3:	b9 0a 00 00 00       	mov    $0xa,%ecx
    14b8:	6a 01                	push   $0x1
    14ba:	eb ce                	jmp    148a <printf+0xea>
    14bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        putc(fd, *ap);
    14c0:	8b 5d d0             	mov    -0x30(%ebp),%ebx
  write(fd, &c, 1);
    14c3:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    14c6:	8b 03                	mov    (%ebx),%eax
  write(fd, &c, 1);
    14c8:	6a 01                	push   $0x1
        ap++;
  ...
  write(fd, &c, 1);
    ...
    14ce:	ff 75 08             	pushl  0x8(%ebp)
        putc(fd, *ap);
    14d1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    14d4:	e8 44 fd ff ff       	call   121d <write>
        ap++;
    14d9:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    14dc:	83 c4 10             	add    $0x10,%esp
      state = 0;
    14df:	31 d2                	xor    %edx,%edx
    14e1:	e9 0e ff ff ff       	jmp    13f4 <printf+0x54>
  ...
  write(fd, &c, 1);
    ...
    14f6:	e9 59 ff ff ff       	jmp    1454 <printf+0xb4>
    ...
    1508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    150b:	85 db                	test   %ebx,%ebx
    150d:	74 17                	je     1526 <printf+0x186>
        while(*s != 0){
    150f:	0f b6 03             	movzbl (%ebx),%eax
      state = 0;
    1512:	31 d2                	xor    %edx,%edx
        while(*s != 0){
    1514:	84 c0                	test   %al,%al
    1516:	0f 84 d8 fe ff ff    	je     13f4 <printf+0x54>
    151c:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    151f:	89 de                	mov    %ebx,%esi
    1521:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1524:	eb 1a                	jmp    1540 <printf+0x1a0>
          s = "(null)";
    1526:	bb 58 18 00 00       	mov    $0x1858,%ebx
        while(*s != 0){
    152b:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    152e:	b8 28 00 00 00       	mov    $0x28,%eax
    1533:	89 de                	mov    %ebx,%esi
    1535:	8b 5d 08             	mov    0x8(%ebp),%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1575:	a1 c8 1f 00 00       	mov    0x1fc8,%eax
{
  ...
  bp = (Header*)ap - 1;
    1584:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1587:	39 c8                	cmp    %ecx,%eax
    1589:	73 15                	jae    15a0 <free+0x30>
    158b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    158f:	90                   	nop
    1590:	39 d1                	cmp    %edx,%ecx
    1592:	72 14                	jb     15a8 <free+0x38>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1594:	39 d0                	cmp    %edx,%eax
    1596:	73 10                	jae    15a8 <free+0x38>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    15ae:	39 fa                	cmp    %edi,%edx
    15b0:	74 1e                	je     15d0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    15b2:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    15b5:	8b 50 04             	mov    0x4(%eax),%edx
    15b8:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    15bb:	39 f1                	cmp    %esi,%ecx
    15bd:	74 28                	je     15e7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    15bf:	89 08                	mov    %ecx,(%eax)
  freep = p;
}
    15c1:	5b                   	pop    %ebx
  freep = p;
    15c2:	a3 c8 1f 00 00       	mov    %eax,0x1fc8
}
    15c7:	5e                   	pop    %esi
    15c8:	5f                   	pop    %edi
    15c9:	5d                   	pop    %ebp
    ...
    15cf:	90                   	nop
    bp->s.size += p->s.ptr->s.size;
    15d0:	03 72 04             	add    0x4(%edx),%esi
    15d3:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    15d6:	8b 10                	mov    (%eax),%edx
    15d8:	8b 12                	mov    (%edx),%edx
    15da:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    15dd:	8b 50 04             	mov    0x4(%eax),%edx
    15e0:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    15e3:	39 f1                	cmp    %esi,%ecx
    15e5:	75 d8                	jne    15bf <free+0x4f>
    p->s.size += bp->s.size;
    15e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    15ea:	a3 c8 1f 00 00       	mov    %eax,0x1fc8
    p->s.size += bp->s.size;
    15ef:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    15f2:	8b 53 f8             	mov    -0x8(%ebx),%edx
    15f5:	89 10                	mov    %edx,(%eax)
}
    15f7:	5b                   	pop    %ebx
    15f8:	5e                   	pop    %esi
    15f9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1610:	8b 3d c8 1f 00 00    	mov    0x1fc8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1616:	8d 70 07             	lea    0x7(%eax),%esi
    1619:	c1 ee 03             	shr    $0x3,%esi
    161c:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    161f:	85 ff                	test   %edi,%edi
    1621:	0f 84 a9 00 00 00    	je     16d0 <malloc+0xd0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1627:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
    1629:	8b 48 04             	mov    0x4(%eax),%ecx
    162c:	39 f1                	cmp    %esi,%ecx
    162e:	73 6d                	jae    169d <malloc+0x9d>
    1630:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    1636:	bb 00 10 00 00       	mov    $0x1000,%ebx
    163b:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    163e:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
    1645:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    1648:	eb 17                	jmp    1661 <malloc+0x61>
    164a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1650:	8b 10                	mov    (%eax),%edx
    if(p->s.size >= nunits){
    1652:	8b 4a 04             	mov    0x4(%edx),%ecx
    1655:	39 f1                	cmp    %esi,%ecx
    1657:	73 4f                	jae    16a8 <malloc+0xa8>
    1659:	8b 3d c8 1f 00 00    	mov    0x1fc8,%edi
    ...
    if(p == freep)
    1661:	39 c7                	cmp    %eax,%edi
    1663:	75 eb                	jne    1650 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
    1665:	83 ec 0c             	sub    $0xc,%esp
    1668:	ff 75 e4             	pushl  -0x1c(%ebp)
    166b:	e8 15 fc ff ff       	call   1285 <sbrk>
  if(p == (char*)-1)
    1670:	83 c4 10             	add    $0x10,%esp
    1673:	83 f8 ff             	cmp    $0xffffffff,%eax
    1676:	74 1b                	je     1693 <malloc+0x93>
  hp->s.size = nu;
    1678:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    167b:	83 ec 0c             	sub    $0xc,%esp
    167e:	83 c0 08             	add    $0x8,%eax
    1681:	50                   	push   %eax
    1682:	e8 e9 fe ff ff       	call   1570 <free>
  return freep;
    1687:	a1 c8 1f 00 00       	mov    0x1fc8,%eax
      if((p = morecore(nunits)) == 0)
    168c:	83 c4 10             	add    $0x10,%esp
    168f:	85 c0                	test   %eax,%eax
    1691:	75 bd                	jne    1650 <malloc+0x50>
        return 0;
  }
}
    ...
    16a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    16a8:	39 ce                	cmp    %ecx,%esi
    16aa:	74 54                	je     1700 <malloc+0x100>
        p->s.size -= nunits;
    16ac:	29 f1                	sub    %esi,%ecx
    16ae:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
    16b1:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
    16b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    16b7:	a3 c8 1f 00 00       	mov    %eax,0x1fc8
}
    16bc:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    16bf:	8d 42 08             	lea    0x8(%edx),%eax
}
    16c2:	5b                   	pop    %ebx
    16c3:	5e                   	pop    %esi
    16c4:	5f                   	pop    %edi
    16c5:	5d                   	pop    %ebp
    16c6:	c3                   	ret    
    16c7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    16ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
    16d0:	c7 05 c8 1f 00 00 cc 	movl   $0x1fcc,0x1fc8
    16d7:	1f 00 00 
    base.s.size = 0;
    16da:	bf cc 1f 00 00       	mov    $0x1fcc,%edi
    base.s.ptr = freep = prevp = &base;
    16df:	c7 05 cc 1f 00 00 cc 	movl   $0x1fcc,0x1fcc
    16e6:	1f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    16e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    16eb:	c7 05 d0 1f 00 00 00 	movl   $0x0,0x1fd0
    16f2:	00 00 00 
    if(p->s.size >= nunits){
    16f5:	e9 36 ff ff ff       	jmp    1630 <malloc+0x30>
    16fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    1700:	8b 0a                	mov    (%edx),%ecx
    1702:	89 08                	mov    %ecx,(%eax)
    1704:	eb b1                	jmp    16b7 <malloc+0xb7>
